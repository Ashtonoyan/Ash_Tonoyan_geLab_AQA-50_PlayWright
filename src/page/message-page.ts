...
export class MessagesPage extends BasePage {
    static async goToMessagesPage() {
        await test.step('Go to Message', async () => {
            await getPage().goto(process.env.MAILFENCE_MAIN_URL!)
    ...
    static async findAndOpenMessage(subjectRandom: string): Promise<void> {
    ...
    static async saveFileInDocumentsFolder() {
