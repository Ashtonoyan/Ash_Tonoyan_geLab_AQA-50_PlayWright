Feature: Mailfence e2e test
  ...
  Scenario Outline: Send and process email
    ...
    And I create new message with 'subjectRandom', fill file as "<filePath>"
    ...
    Then I should see the file with as "<fileName>" in folder

    Examples:
      | filePath                                | fileName                       |
      | ../files/Mailfence.e2e.UI.test.case.pdf | Mailfence.e2e.UI.test.case.pdf |
